...
found within a TAR UMT Student Assistant App. For groups of members, 
the program should display a main menu with these applications.
...
4. Notes Organizer
A Notes Organizer provides a digital space for users to jot down ideas,
thoughts, and information. It allows for organizing notes into folders or
categories, adding tags for easy searching, and even attaching images or links
